...
public class Item {
    ...
    // Only expose safe user fields — prevents User→Items→User circular loop
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "user_id")
    @JsonIgnoreProperties({"password", "firebaseUid", "fcmToken", "emailVerified",
    ...
    // Multiple Images — images don't need to know about their parent item when serialized
    @OneToMany(mappedBy = "item", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    @OrderBy("uploadOrder ASC")
    ...
    public boolean isAiMatched() { return aiMatched; }
    public void setAiMatched(boolean aiMatched) { this.aiMatched = aiMatched; }
    ...
    public void setAiDetectedCategory(String aiDetectedCategory) { this.aiDetectedCategory = aiDetectedCategory; }
    ...
    public String getAiDetectedColors() { return aiDetectedColors; }
    public void setAiDetectedColors(String aiDetectedColors) { this.aiDetectedColors = aiDetectedColors; }

    public String getAiDetectedBrands() { return aiDetectedBrands; }
    public void setAiDetectedBrands(String aiDetectedBrands) { this.aiDetectedBrands = aiDetectedBrands; }
